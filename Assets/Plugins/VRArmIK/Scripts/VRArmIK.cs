...
namespace VRArmIK
{
	...
	public class VRArmIK : MonoBehaviour
	{
        ...
        [HideInInspector]
        public Quaternion upperArmStartRotation, lowerArmStartRotation, wristStartRotation, handStartRotation;
		...
		public Quaternion upperArmRotation => arm.upperArm.rotation * Quaternion.Inverse(upperArmStartRotation);
        public Quaternion lowerArmRotation => arm.lowerArm.rotation * Quaternion.Inverse(lowerArmStartRotation);
        public Quaternion handRotation => arm.hand.rotation * Quaternion.Inverse(handStartRotation);
